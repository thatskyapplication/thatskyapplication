...
export const MISCELLANEOUS_EMOJIS = PRODUCTION
	? ({
			...
			SpellColourTrail: { id: "1313930723169669200" },
			SpellSharedMemory: { id: "1313930708724613192" },
			SpellSharedSpace: { id: "1313930710230241383" },
			WingBuff: { id: "1313930701623656551" },
			Quest: { id: "1313930722012168282" },
	...
	: ({
			...
			SpellColourTrail: { id: "1313864878309638244" },
			SpellSharedMemory: { id: "1313864882738823328" },
			SpellSharedSpace: { id: "1313864885460926544" },
			WingBuff: { id: "1313864888686215261" },
			Quest: { id: "1313864897657831510" },
