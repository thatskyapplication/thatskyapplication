...
export default new StandardSpirit({
	...
	offer: {
		current: [
			...
			{ name: "Wing buff 1", bit: 1 << 5, cost: { ascendedCandles: 2 }, emoji: MISCELLANEOUS_EMOJIS.WingBuff },
			...
			{ name: "Wing buff 2", bit: 1 << 10, cost: { ascendedCandles: 6 }, emoji: MISCELLANEOUS_EMOJIS.WingBuff },
