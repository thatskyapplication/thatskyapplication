...
export default new StandardSpirit({
	...
	offer: {
		current: [
			...
			{ name: "Hair", bit: 1 << 3, cost: { hearts: 3 }, emoji: HAIR_EMOJIS.Hair16 },
			...
			{ name: "Wing buff 2", bit: 1 << 9, cost: { ascendedCandles: 3 }, emoji: MISCELLANEOUS_EMOJIS.WingBuff },
			{ name: `${emote} 5`, bit: 1 << 10, cost: { candles: 5 }, emoji: emoteEmoji },
			{ name: `${emote} 6`, bit: 1 << 11, cost: { candles: 5 }, emoji: emoteEmoji },
		],
	},
});
