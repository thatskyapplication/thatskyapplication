...
export default new StandardSpirit({
	...
	offer: {
		current: [
			...
			{ name: "Hair", bit: 1 << 3, cost: { hearts: 5 }, emoji: HAIR_EMOJIS.Hair14 },
			{ name: "Heart", bit: 1 << 4, cost: { candles: 3 }, emoji: MISCELLANEOUS_EMOJIS.Heart },
			{ name: "Wing buff 1", bit: 1 << 5, cost: { ascendedCandles: 3 }, emoji: MISCELLANEOUS_EMOJIS.WingBuff },
			...
			{ name: "Cape 1", bit: 1 << 9, cost: { hearts: 30 }, emoji: CAPE_EMOJIS.Cape06 },
			{ name: "Wing buff 2", bit: 1 << 10, cost: { ascendedCandles: 9 }, emoji: MISCELLANEOUS_EMOJIS.WingBuff },
			{ name: "Cape 2", bit: 1 << 11, cost: { hearts: 90 }, emoji: CAPE_EMOJIS.Cape50 },
		],
	},
});
