...
export default new StandardSpirit({
	...
	offer: {
		current: [
			...
			{ name: `${emote} 2`, bit: 1 << 1, cost: { candles: 2 }, emoji: emoteEmoji },
			{
				name: "Blessing 1",
				bit: 1 << 2,
				cost: { candles: 1 },
			...
			{ name: "Outfit", bit: 1 << 3, cost: { hearts: 2 }, emoji: OUTFIT_EMOJIS.Outfit05 },
			...
			{ name: "Hair", bit: 1 << 9, cost: { hearts: 5 }, emoji: HAIR_EMOJIS.Hair10 },
		],
	},
});
