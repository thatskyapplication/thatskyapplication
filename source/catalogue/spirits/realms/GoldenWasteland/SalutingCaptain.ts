...
export default new StandardSpirit({
	...
	offer: {
		current: [
			...
			{ name: `${emote} 2`, bit: 1 << 1, cost: { candles: 4 }, emoji: emoteEmoji },
			{ name: "Blessing 1", bit: 1 << 2, cost: { candles: 1 }, emoji: MISCELLANEOUS_EMOJIS.Blessing1 },
			{ name: "Hair", bit: 1 << 3, cost: { hearts: 5 }, emoji: HAIR_EMOJIS.Hair25 },
			...
			{ name: "Fireworks staff", bit: 1 << 9, cost: { hearts: 20 }, emoji: HELD_PROPS_EMOJIS.HeldProp06 },
		],
	},
});
