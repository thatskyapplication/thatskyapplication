...
export default new StandardSpirit({
	...
	offer: {
		current: [
			...
			{ name: "Wing buff 1", bit: 1 << 4, cost: { ascendedCandles: 4 }, emoji: MISCELLANEOUS_EMOJIS.WingBuff },
			...
			{ name: "Wing buff 2", bit: 1 << 7, cost: { ascendedCandles: 12 }, emoji: MISCELLANEOUS_EMOJIS.WingBuff },
