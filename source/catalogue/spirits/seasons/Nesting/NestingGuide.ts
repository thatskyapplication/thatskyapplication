...
export default new GuideSpirit({
	...
	offer: {
		current: new Collection<number, ItemRaw>()
			...
			.set(1 << 2, { name: "Pendant", emoji: NECKLACE_EMOJIS.Necklace34 })
			...
			.set(1 << 6, { name: "Heart 2", emoji: MISCELLANEOUS_EMOJIS.Heart })
			.set(1 << 7, { name: "Quest 3", emoji: MISCELLANEOUS_EMOJIS.Quest })
			.set(1 << 8, { name: "Heart 3", emoji: MISCELLANEOUS_EMOJIS.Heart })
			.set(1 << 9, { name: "Quest 4", emoji: MISCELLANEOUS_EMOJIS.Quest })
			.set(1 << 10, { name: "Heart 4", emoji: MISCELLANEOUS_EMOJIS.Heart })
			.set(1 << 11, { name: "Quest 5", emoji: MISCELLANEOUS_EMOJIS.Quest })
			.set(1 << 12, { name: "Heart 5", emoji: MISCELLANEOUS_EMOJIS.Heart }),
	},
});
