...
export default new SeasonalSpirit({
	...
	offer: {
		current: [
			...
			{ name: "Blessing 1", bit: 1 << 2, cost: { candles: 5 }, emoji: blessing3 },
			...
			{ name: "Cape", bit: 1 << 8, cost: { candles: 20 }, emoji: capeEmoji },
		],
		seasonal: [
			{ name: `${emote} 1`, bit: 1 << 0, emoji: emoteEmoji },
			...
			{ name: "Mask", bit: 1 << 4, cost: { seasonalCandles: 8 }, emoji: maskEmoji },
			...
			{ name: "Cape", bit: 1 << 8, cost: { seasonalCandles: 20 }, emoji: capeEmoji },
			{ name: "Blessing 3", bit: 1 << 9, emoji: blessing3 },
			{ name: "Seasonal heart", bit: 1 << 10, cost: { seasonalCandles: 3 }, emoji: SEASON_EMOJIS.AbyssHeart },
		],
	},
	visits: {
		returning: [5],
