...
export default new SeasonalSpirit({
	...
	offer: {
		seasonal: [
			...
			{ name: "Seasonal heart", bit: 1 << 8, cost: { seasonalCandles: 3 }, emoji: SEASON_EMOJIS.LittlePrinceHeart },
		],
		current: [
			{ name: `${emote} 1`, bit: 1 << 0, emoji: emoteEmoji },
			...
			{ name: "Wing buff", bit: 1 << 9, cost: { ascendedCandles: 2 }, emoji: MISCELLANEOUS_EMOJIS.WingBuff },
