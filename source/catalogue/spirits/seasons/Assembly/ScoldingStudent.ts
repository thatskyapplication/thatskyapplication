...
export default new SeasonalSpirit({
	...
	offer: {
		...
		seasonal: [
			...
			{ name: "Mask", bit: 1 << 3, cost: { seasonalCandles: 10 }, emoji: maskEmoji },
			...
			{ name: "Hair", bit: 1 << 9, cost: { seasonalCandles: 18 }, emoji: hairEmoji },
		...
		current: [
			...
			{ name: "Hair", bit: 1 << 9, cost: { candles: 50 }, emoji: hairEmoji },
