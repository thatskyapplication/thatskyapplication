...
export default new SeasonalSpirit({
	...
	offer: {
		...
		seasonal: [
			...
			{ name: "Music sheet", bit: 1 << 3, cost: { seasonalCandles: 8 }, emoji: musicSheet },
			...
			{ name: "Mask", bit: 1 << 10, cost: { seasonalCandles: 12 }, emoji: maskEmoji },
		...
		current: [
			...
			{ name: "Mask", bit: 1 << 10, cost: { candles: 48 }, emoji: maskEmoji },
		],
	},
	visits: {
