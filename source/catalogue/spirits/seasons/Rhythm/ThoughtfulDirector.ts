...
export default new SeasonalSpirit({
	...
	offer: {
		seasonal: new Collection<number, ItemRaw>()
			...
			.set(1 << 2, { name: "Blessing 1", cost: { seasonalCandles: 16 }, emoji: blessing2 })
			...
			.set(1 << 9, { name: "Xylophone", cost: { seasonalCandles: 20 }, emoji: heldProp })
			.set(1 << 8, { name: "Blessing 2", emoji: blessing2 })
			.set(1 << 11, { name: "Blessing 3", cost: { seasonalCandles: 22 }, emoji: blessing2 })
			.set(1 << 10, { name: "Cape", emoji: capeEmoji })
		...
		current: new Collection<number, ItemRaw>()
			...
			.set(1 << 9, { name: "Xylophone", cost: { candles: 65 }, emoji: heldProp })
