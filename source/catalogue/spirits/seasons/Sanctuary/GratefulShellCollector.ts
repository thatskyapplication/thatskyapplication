...
export default new SeasonalSpirit({
	...
	offer: {
		...
		seasonal: [
			...
			{ name: "Cape", bit: 1 << 10, cost: { seasonalCandles: 18 }, emoji: capeEmoji },
		...
		current: [
			...
			{ name: "Chairs", bit: 1 << 2, cost: { candles: 45 }, emoji: placeablePropEmoji },
			{ name: "Blessing 1", bit: 1 << 3, cost: { candles: 5 }, emoji: blessing2 },
			{ name: "Hair", bit: 1 << 4, cost: { candles: 34 }, emoji: hairEmoji },
