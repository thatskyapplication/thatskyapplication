...
export default new SeasonalSpirit({
	...
	offer: {
		...
		seasonal: [
			...
			{ name: "Blessing", bit: 1 << 2, cost: { seasonalCandles: 14 }, emoji: blessing2 },
			{ name: "Guitar", bit: 1 << 10, emoji: heldProp },
			{ name: `${emote} 3`, bit: 1 << 6, cost: { seasonalCandles: 16 }, emoji: emoteEmoji },
			{ name: `${emote} 4`, bit: 1 << 7, emoji: emoteEmoji },
			{ name: "Mask", bit: 1 << 3, cost: { seasonalCandles: 18 }, emoji: maskEmoji },
		...
		current: [
			...
			{ name: "Guitar", bit: 1 << 10, cost: { candles: 75 }, emoji: heldProp },
		],
	},
	visits: {
