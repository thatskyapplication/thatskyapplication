...
export default new SeasonalSpirit({
	...
	offer: {
		...
		seasonal: new Collection<number, ItemRaw>()
			...
			.set(1 << 3, { name: "Hair", cost: { seasonalCandles: 13 }, emoji: hairEmoji })
			...
			.set(1 << 8, { name: "Mask", cost: { seasonalCandles: 23 }, emoji: maskEmoji })
			.set(1 << 9, { name: "Blessing 2", emoji: blessing2 })
			.set(1 << 11, { name: "Blessing 3", cost: { seasonalCandles: 29 }, emoji: blessing2 })
		...
		current: new Collection<number, ItemRaw>()
			...
			.set(1 << 8, { name: "Mask", cost: { candles: 42 }, emoji: maskEmoji })
