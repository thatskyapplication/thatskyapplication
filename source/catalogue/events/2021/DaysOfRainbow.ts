...
export default new Event({
	...
	offer: [
		{ name: "Rainbow braid", bit: 1 << 0, cost: { hearts: 20 }, emoji: FACE_ACCESSORY_EMOJIS.FaceAccessory13 },
		{ name: "Rainbow cape", bit: 1 << 1, cost: { candles: 175 }, emoji: CAPE_EMOJIS.Cape56 },
		{ name: "Rainbow Pack", bit: 1 << 2, cost: { money: 19.99 }, emoji: HAIR_ACCESSORY_EMOJIS.HairAccessory05 },
