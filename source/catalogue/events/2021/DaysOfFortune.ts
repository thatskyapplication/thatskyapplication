...
export default new Event({
	...
	offer: [
		...
		{ name: "Days of Fortune Pack", bit: 1 << 2, cost: { money: 24.99 }, emoji: CAPE_EMOJIS.Cape49 },
		{ name: "Days of Fortune Wool Hat", bit: 1 << 3, cost: { money: 9.99 }, emoji: HAIR_EMOJIS.Hair74 },
		{
