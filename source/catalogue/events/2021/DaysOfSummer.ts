...
export default new Event({
	...
	offer: [
		{ name: "Prop", bit: 1 << 0, cost: { hearts: 16 }, emoji: LARGE_PLACEABLE_PROPS_EMOJIS.LargePlaceableProp13 },
		{ name: "Hair accessory", bit: 1 << 1, cost: { candles: 44 }, emoji: HAIR_ACCESSORY_EMOJIS.HairAccessory07 },
		{ name: "Days of Summer Umbrella", bit: 1 << 2, cost: { money: 19.99 }, emoji: HELD_PROPS_EMOJIS.HeldProp23 },
		{
