...
import { CAPE_EMOJIS, HAIR_EMOJIS, OUTFIT_EMOJIS, SMALL_PLACEABLE_PROPS_EMOJIS } from "../../../Utility/emojis.js";
...
export default new Event({
	...
	offer: new Collection<number, ItemRaw>()
		...
		.set(1 << 2, { name: "Prop", cost: { hearts: 33 }, emoji: SMALL_PLACEABLE_PROPS_EMOJIS.SmallPlaceableProp08 })
