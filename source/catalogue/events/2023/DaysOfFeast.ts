...
export default new Event({
	...
	offer: [
		...
		{ name: "Hair accessory", bit: 1 << 1, cost: { eventCurrency: 19 }, emoji: HAIR_ACCESSORY_EMOJIS.HairAccessory34 },
		{ name: "Cosy Hermit Boots", bit: 1 << 2, cost: { money: 6.99 }, emoji: SHOE_EMOJIS.Shoe13 },
		{ name: "Winter Quilted Cape", bit: 1 << 3, cost: { money: 14.99 }, emoji: CAPE_EMOJIS.Cape120 },
	],
});
