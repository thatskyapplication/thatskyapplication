...
const items = resolveOffer([
	...
	{ name: "Moth Appreciation Pack", bit: 1 << 1, cost: { money: 9.99 }, emoji: CAPE_EMOJIS.Cape119 },
	{ name: "Sparrow Appreciation Pack", bit: 1 << 2, cost: { money: 9.99 }, emoji: CAPE_EMOJIS.Cape118 },
	{
