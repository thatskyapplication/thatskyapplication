...
const emoteEmoji = EMOTE_EMOJIS.Stretch;
...
export default new SeasonalSpirit({
	...
	offer: {
		seasonal: new Collection<number, ItemsData>()
			...
			.set(1 << 7, { item: "Blessing 2", cost: null, emoji: blessing2 })
