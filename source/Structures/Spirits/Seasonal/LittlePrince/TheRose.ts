...
export default new GuideSpirit({
	...
	offer: {
		...
		current: new Collection<number, ItemsData>()
			...
			.set(1 << 14, { item: "Quest 6", cost: null, emoji: MISCELLANEOUS_EMOJIS.Quest })
			.set(1 << 15, { item: "Heart 6", cost: { candles: 3 }, emoji: MISCELLANEOUS_EMOJIS.Heart })
			.set(1 << 16, { item: "Quest 7", cost: null, emoji: MISCELLANEOUS_EMOJIS.Quest })
			.set(1 << 17, { item: "Heart 7", cost: { candles: 3 }, emoji: MISCELLANEOUS_EMOJIS.Heart })
			.set(1 << 18, { item: "Sword outfit", cost: { candles: 200 }, emoji: OUTFIT_EMOJIS.Outfit22 }),
	},
});
