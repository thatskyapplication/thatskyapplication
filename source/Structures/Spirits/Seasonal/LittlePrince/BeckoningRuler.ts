...
const emote = Emote.Beckon;
const blessing2 = MISCELLANEOUS_EMOJIS.Blessing2;
const emoteEmoji = EMOTES_EMOJIS.Beckon;
...
export default new SeasonalSpirit({
	...
	offer: {
		...
		seasonal: new Collection<number, ItemsData>()
			...
			.set(1 << 3, { item: "Blessing 1", cost: { seasonalCandles: 14 }, emoji: blessing2 })
			.set(1 << 9, { item: "Hair", cost: null, emoji: hairEmoji })
			.set(1 << 6, { item: `${emote} 3`, cost: { seasonalCandles: 20 }, emoji: emoteEmoji })
			.set(1 << 7, { item: `${emote} 4`, cost: null, emoji: emoteEmoji })
			.set(1 << 4, { item: "Frog mask", cost: { seasonalCandles: 26 }, emoji: maskEmoji })
		...
		current: new Collection<number, ItemsData>()
			...
			.set(1 << 4, { item: "Frog mask", cost: { candles: 42 }, emoji: maskEmoji })
			...
			.set(1 << 9, { item: "Hair", cost: { candles: 48 }, emoji: hairEmoji }),
	},
