...
const actonEmoji = FRIEND_ACTIONS_EMOJIS.DoubleFive;
...
export default new SeasonalSpirit({
	...
	offer: {
		...
		current: new Collection<number, ItemsData>()
			...
			.set(1 << 6, { item: `${action} 2`, cost: { hearts: 7 }, emoji: actonEmoji })
