...
export default new GuideSpirit({
	...
	offer: {
		current: new Collection<number, ItemsData>()
			...
			.set(1 << 6, { item: `${Emote.SilentClap} 1`, cost: null, emoji: EMOTES_EMOJIS.SilentClap })
			.set(1 << 7, { item: `${Emote.SilentClap} 3`, cost: { candles: 5 }, emoji: EMOTES_EMOJIS.SilentClap })
			.set(1 << 8, { item: `${Emote.SilentClap} 4`, cost: { hearts: 5 }, emoji: EMOTES_EMOJIS.SilentClap })
			.set(1 << 9, { item: "Quest 2", cost: null, emoji: MISCELLANEOUS_EMOJIS.Quest })
			.set(1 << 10, { item: `${Emote.Conduct} 1`, cost: null, emoji: EMOTES_EMOJIS.Conduct })
			.set(1 << 11, { item: `${Emote.Conduct} 2`, cost: { hearts: 3 }, emoji: EMOTES_EMOJIS.Conduct })
			.set(1 << 12, { item: `${Emote.Conduct} 3`, cost: { candles: 5 }, emoji: EMOTES_EMOJIS.Conduct })
			.set(1 << 13, { item: `${Emote.Conduct} 4`, cost: { hearts: 5 }, emoji: EMOTES_EMOJIS.Conduct })
			...
			.set(1 << 16, { item: `${Emote.Skipping} 1`, cost: null, emoji: EMOTES_EMOJIS.Skipping })
			.set(1 << 17, { item: `${Emote.Skipping} 2`, cost: { hearts: 3 }, emoji: EMOTES_EMOJIS.Skipping })
			.set(1 << 18, { item: `${Emote.Skipping} 3`, cost: { candles: 5 }, emoji: EMOTES_EMOJIS.Skipping })
			.set(1 << 19, { item: `${Emote.Skipping} 4`, cost: { hearts: 5 }, emoji: EMOTES_EMOJIS.Skipping })
