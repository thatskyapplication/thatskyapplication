...
export default new GuideSpirit({
	...
	offer: {
		current: new Collection<number, ItemsData>()
			...
			.set(1 << 10, { item: "Heart 3", cost: null, emoji: MISCELLANEOUS_EMOJIS.Heart })
			...
			.set(1 << 12, { item: "Heart 4", cost: null, emoji: MISCELLANEOUS_EMOJIS.Heart })
			.set(1 << 13, { item: "Quest 5", cost: null, emoji: MISCELLANEOUS_EMOJIS.Quest })
			.set(1 << 14, { item: "Heart 5", cost: null, emoji: MISCELLANEOUS_EMOJIS.Heart })
			.set(1 << 15, { item: "Quest 6", cost: null, emoji: MISCELLANEOUS_EMOJIS.Quest })
			.set(1 << 16, { item: "Heart 6", cost: null, emoji: MISCELLANEOUS_EMOJIS.Heart })
