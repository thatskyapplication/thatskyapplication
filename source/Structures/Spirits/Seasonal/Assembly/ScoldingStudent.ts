...
const emote = Emote.Scold;
const emoteEmoji = EMOTES_EMOJIS.Scold;
...
export default new SeasonalSpirit({
	...
	offer: {
		...
		current: new Collection<number, ItemsData>()
			...
			.set(1 << 9, { item: "Hair", cost: { candles: 50 } })
