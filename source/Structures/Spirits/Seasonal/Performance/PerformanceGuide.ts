...
export default new GuideSpirit({
	...
	offer: {
		...
		current: new Collection<number, ItemsData>()
			...
			.set(1 << 6, { item: FriendAction.HighFive, cost: null })
			...
			.set(1 << 12, { item: FriendAction.DoubleFive, cost: null })
			...
			.set(1 << 16, { item: FriendAction.Hug, cost: null })
			...
			.set(1 << 20, { item: FriendAction.DuetDance, cost: null })
