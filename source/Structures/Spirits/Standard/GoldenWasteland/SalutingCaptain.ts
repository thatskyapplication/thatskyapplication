...
const emote = Emote.Salute;
const emoteEmoji = EMOTES_EMOJIS.Salute;
...
export default new StandardSpirit({
	...
	offer: {
		current: new Collection<number, ItemsData>()
			...
			.set(1 << 3, { item: "Hair", cost: { hearts: 5 }, emoji: HAIR_EMOJIS.Hair25 })
			...
			.set(1 << 9, { item: "Fireworks staff", cost: { hearts: 20 }, emoji: HELD_PROPS_EMOJIS.HeldProp06 }),
	},
});
