...
import { EMOTES_EMOJIS, HAIR_EMOJIS, HELD_PROPS_EMOJIS, MISCELLANEOUS_EMOJIS } from "../../../../Utility/emojis.js";
import { type ItemsData, Emote, SpiritName, StandardSpirit } from "../../Base.js";

const emote = Emote.Shy;
const emoteEmoji = EMOTES_EMOJIS.Shy;

export default new StandardSpirit({
	name: SpiritName.BlushingProspector,
	emote,
	...
	offer: {
		current: new Collection<number, ItemsData>()
			...
			.set(1 << 3, { item: "Hair", cost: { hearts: 3 }, emoji: HAIR_EMOJIS.Hair11 })
			...
			.set(1 << 9, { item: "Drum", cost: { hearts: 5 }, emoji: HELD_PROPS_EMOJIS.HeldProp02 }),
	},
});
