...
const emote = Emote.Laugh;
const emoteEmoji = EMOTES_EMOJIS.Laugh;
...
export default new StandardSpirit({
	...
	offer: {
		current: new Collection<number, ItemsData>()
			...
			.set(1 << 3, { item: "Harp", cost: { hearts: 5 }, emoji: HELD_PROPS_EMOJIS.HeldProp01 })
			...
			.set(1 << 8, { item: "Hair", cost: { hearts: 5 }, emoji: HAIR_EMOJIS.Hair08 })
