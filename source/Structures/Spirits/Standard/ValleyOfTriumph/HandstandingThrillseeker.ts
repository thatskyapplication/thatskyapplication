...
export default new StandardSpirit({
	...
	offer: {
		current: new Collection<number, ItemsData>()
			...
			.set(1 << 1, { item: `${emote} 2`, cost: { candles: 3 } })
			.set(1 << 2, { item: "Blessing 1", cost: { candles: 1 } })
			.set(1 << 3, { item: "Heart", cost: { candles: 3 } })
			.set(1 << 4, { item: "Wing buff 1", cost: { ascendedCandles: 3 } })
			.set(1 << 5, { item: `${emote} 3`, cost: { candles: 4 } })
			.set(1 << 6, { item: `${emote} 4`, cost: { candles: 4 } })
			.set(1 << 7, { item: "Blessing 2", cost: { candles: 5 } })
			.set(1 << 8, { item: "Cape 1", cost: { hearts: 40 } })
			.set(1 << 9, { item: "Wing buff 2", cost: { ascendedCandles: 9 } })
			.set(1 << 10, { item: "Cape 2", cost: { hearts: 120 } }),
	},
});
