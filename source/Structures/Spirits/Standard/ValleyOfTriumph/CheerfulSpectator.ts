...
const emote = Emote.Cheer;
const emoteEmoji = EMOTES_EMOJIS.Cheer;
...
export default new StandardSpirit({
	...
	offer: {
		current: new Collection<number, ItemsData>()
			...
			.set(1 << 3, { item: "Hair", cost: { hearts: 5 }, emoji: HAIR_EMOJIS.Hair19 })
			...
			.set(1 << 9, { item: "Piano", cost: { hearts: 10 }, emoji: HELD_PROPS_EMOJIS.HeldProp03 }),
	},
});
