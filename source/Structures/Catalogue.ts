...
const CatalogueNameToRawName = {
	...
	[SeasonName.NineColouredDeer]: "season_of_the_nine_coloured_deer",
...
const SpiritEventNameToCatalogueName = {
	...
	[SpiritName.Princess]: "princess",
	[SeasonName.NineColouredDeer]: "seasonOfTheNineColouredDeer",
...
export class Catalogue {
	...
	public daysOfSunlight2024!: CatalogueData["daysOfSunlight2024"];

	public daysOfMoonlight2024!: CatalogueData["daysOfMoonlight2024"];
	...
	private async setStarterPacksItems(interaction: ButtonInteraction | StringSelectMenuInteraction) {
		...
		const [cataloguePacket] = await Catalogue.update(interaction.user.id, {
			[CatalogueNameToRawName[CatalogueType.StarterPacks]]: newBit,
		});
