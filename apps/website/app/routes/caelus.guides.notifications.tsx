		...
		<div className="relative overflow-hidden">
			...
			<div className="relative z-10">
				<div className="text-center mb-8">
					<div className="inline-flex items-center justify-center w-16 h-16 bg-linear-to-r from-amber-100 to-orange-100 dark:from-amber-900/30 dark:to-orange-900/30 rounded-full mb-4">
						<Bell className="w-8 h-8 text-amber-600 dark:text-amber-400" />
					</div>
					<h1 className="bg-linear-to-r from-amber-600 via-orange-600 to-red-600 dark:from-amber-400 dark:via-orange-400 dark:to-red-400 bg-clip-text text-transparent">
						Notifications
					</h1>
				...
				<section className="space-y-6">
					...
					<div className="bg-linear-to-br from-purple-50 to-violet-50 dark:from-purple-900/20 dark:to-violet-900/20 border border-purple-200 dark:border-purple-700/50 rounded-xl p-6">
						...
						<div className="grid md:grid-cols-2 gap-4">
							{NOTIFICATION_TYPE_VALUES.map((notification) => (
								<div
									className="bg-white/60 dark:bg-gray-800/60 rounded-lg p-4 backdrop-blur-xs"
									key={notification}
								>
				...
				<section className="space-y-6">
					...
					<div className="bg-linear-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 border border-green-200 dark:border-green-700/50 rounded-xl p-6">
						<div className="flex items-center gap-3 mb-4">
