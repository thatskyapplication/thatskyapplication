		...
		<>
			...
			<h2 className="m-0 text-size-inherit font-medium leading-snug" id="user-info">
				<span className="mr-1" id="username">
					<span className="cursor-pointer text-base font-medium text-[rgb(6,6,7)] dark:text-[rgb(242,243,245)] hover:underline">{username}</span>
					{bot ? (
				...
				<span className="ml-1 cursor-default text-xs leading-snug dark:text-[rgb(148,155,164)] text-[rgb(49,51,56)]" id="time">
					{time ?? timeString}
				</span>
			</h2>
		</>
