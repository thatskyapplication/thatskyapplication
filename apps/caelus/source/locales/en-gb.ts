...
export default {
	general: {
		...
		countries: {
			...
			[Country.CocosIslands]: "Cocos (Keeling) Islands (the)",
			...
			[Country.FalklandIslands]: "Falkland Islands (the) [Malvinas]",
			...
			[Country.UnitedStatesOfAmerica]: "United States of America (the)",
