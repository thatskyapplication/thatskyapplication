...
const envSchema = z.object({
	...
	CROWDIN_RAW_WEBHOOK_ID: z.string().min(1),
	...
	CROWDIN_CHANNEL_ID: z.string().min(1),
	CROWDIN_RAW_CHANNEL_ID: z.string().min(1),
