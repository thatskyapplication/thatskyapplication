...
export const ScheduleTypeToLocaleKey = {
	[ScheduleType.DailyReset]: "general:notification-types.0",
	[ScheduleType.EyeOfEden]: "general:areas.Eye of Eden",
	[ScheduleType.InternationalSpaceStation]: "general:notification-types.2",
	[ScheduleType.TravellingSpirit]: "general:travelling-spirit",
	[ScheduleType.Dragon]: "general:notification-types.3",
	[ScheduleType.PollutedGeyser]: "general:notification-types.4",
	[ScheduleType.Grandma]: "general:notification-types.5",
	...
	[ScheduleType.NestingWorkshop]: "general:notification-types.14",
