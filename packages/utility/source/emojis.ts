...
export function emojiConstants(production: boolean) {
	...
	const CosmeticToEmoji = {
		...
		[Cosmetic.RunningWayfarerSeasonalHeart]: MISCELLANEOUS_EMOJIS.Heart,
		...
		[Cosmetic.SeedOfHopeSeasonalHeart]: MISCELLANEOUS_EMOJIS.Heart,
	...
	const EventIdToEventTicketEmoji = {
		...
		[EventId.SkyAnniversary2025]: EVENT_EMOJIS.SkyAnniversary,
