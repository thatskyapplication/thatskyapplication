...
export default {
	general: {
		...
		spirits: {
			...
			[SpiritId.BlueBirdGuide]: "Guide de l'Oiseau bleu",
			[SpiritId.CostumedConfettiCousin]: "Cousine des confettis costumée",
			[SpiritId.DiviningWiseGrandparent]: "Grand-parent sage divinateur",
			[SpiritId.WoodcuttingPleafulParent]: "Parent suppliant bûcheron",
			[SpiritId.NostalgicSparklerParent]: "Parente étincelante nostalgique",
			[SpiritId.RoyalHairtousleTeen]: "Adolescent ébouriffé royal",
		},
		timestamps: "Heures",
		view: "Voir",
	},
