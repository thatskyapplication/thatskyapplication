...
export default {
	general: {
		...
		areas: {
			...
			[AreaName.CaveOfProphecies]: "Cave of Prophecies",
			...
			[AreaName.FracturedLanternStorage]: "Fractured Lantern Storage",
			...
			[AreaName.TheVoidOfShattering]: "The Void of Shattering",
