...
export default {
	general: {
		...
		areas: {
			...
			[AreaName.StarryGallery]: "Starry Gallery",
		...
		seasons: {
			...
			[SeasonId.Moments]: "Season of Moments",
		...
		spirits: {
			...
			[SpiritId.VaseWithFifteenSunflowers]: "Vase with Fifteen Sunflowers",
			[SpiritId.DutchMemory]: "Dutch Memory",
		...
		"spirit-wiki": {
			...
			[SpiritId.VaseWithFifteenSunflowers]:
				"https://sky-children-of-the-light.fandom.com/Vase_with_Fifteen_Sunflowers",
			[SpiritId.DutchMemory]: "https://sky-children-of-the-light.fandom.com/Dutch_Memory",
		...
		"cosmetic-common-names": {
			...
			[CosmeticCommon.Pendant]: "Pendant",
			[CosmeticCommon.Prop]: "Prop",
			...
			[CosmeticCommon.PropMultiple]: "Prop {{number}}",
			[CosmeticCommon.HeadAccessory]: "Head accessory",
			[CosmeticCommon.NeckAccessory]: "Neck accessory",
			[CosmeticCommon.MantaCape]: "Manta cape",
			[CosmeticCommon.Hug]: "Hug",
			[CosmeticCommon.HighFive]: "High-five",
			[CosmeticCommon.DoubleFive]: "Double-five",
			[CosmeticCommon.Trust]: "Trust",
			[CosmeticCommon.UltimateCape]: "Ultimate cape",
			[CosmeticCommon.UltimateFaceAccessory]: "Ultimate face accessory",
			[CosmeticCommon.UltimateHair]: "Ultimate hair",
			[CosmeticCommon.UltimateHairAccessory]: "Ultimate hair accessory",
			[CosmeticCommon.UltimateHeadAccessory]: "Ultimate head accessory",
			[CosmeticCommon.UltimateMask]: "Ultimate mask",
			[CosmeticCommon.UltimateOutfit]: "Ultimate outfit",
			[CosmeticCommon.UltimateProp]: "Ultimate prop",
			[CosmeticCommon.Umbrella]: "Umbrella",
			[CosmeticCommon.Dye]: "Dye",
			[CosmeticCommon.DyeMultiple]: "Dye {{number}}",
			[CosmeticCommon.TrailSpell]: "Trail spell",
			[CosmeticCommon.TrailSpellMultiple]: "Trail spell {{number}}",
			[CosmeticCommon.BlackDye]: "Black dye",
			[CosmeticCommon.BlueDye]: "Blue dye",
			[CosmeticCommon.CyanDye]: "Cyan dye",
			[CosmeticCommon.GreenDye]: "Green dye",
			[CosmeticCommon.GreenDyeMultiple]: "Green dye {{number}}",
			[CosmeticCommon.PurpleDye]: "Purple dye",
			[CosmeticCommon.RedDye]: "Red dye",
			[CosmeticCommon.WhiteDye]: "White dye",
			[CosmeticCommon.YellowDye]: "Yellow dye",
			[CosmeticCommon.YellowDyeMultiple]: "Yellow dye {{number}}",
			[CosmeticCommon.CapeMultiple]: "Cape {{number}}",
			[CosmeticCommon.HairMultiple]: "Hair {{number}}",
			[CosmeticCommon.BlueDyeMultiple]: "Blue dye {{number}}",
			[CosmeticCommon.CyanDyeMultiple]: "Cyan dye {{number}}",
			[CosmeticCommon.PurpleDyeMultiple]: "Purple dye {{number}}",
			[CosmeticCommon.RedDyeMultiple]: "Red dye {{number}}",
			[CosmeticCommon.UltimatePropMultiple]: "Ultimate prop {{number}}",
			[CosmeticCommon.SharedMemorySpell]: "Shared memory spell",
			[CosmeticCommon.SharedMemorySpellMultiple]: "Shared memory spell {{number}}",
		...
		"cosmetic-pack-names": {
			[CosmeticPackName.DaysOfFortunePack]: "Days of Fortune Pack",
			[CosmeticPackName.NintendoSwitchPack]: "Red & Blue Starter Pack",
			[CosmeticPackName.DaysOfFortuneFishPack]: "Days of Fortune Fish Pack",
			[CosmeticPackName.KizunaAIPack]: "KizunaAI Pack",
			[CosmeticPackName.CatCostumePack]: "Cat Costume Pack",
			[CosmeticPackName.JourneyPack]: "Journey Pack",
			[CosmeticPackName.MothAppreciationPack]: "Moth Appreciation Pack",
			[CosmeticPackName.SparrowAppreciationPack]: "Sparrow Appreciation Pack",
			[CosmeticPackName.CinnamorollPopUpCafeHairAndEars]: "Cinnamoroll Pop-Up Cafe Combo",
			[CosmeticPackName.CinnamorollPopUpCafeBowtieAndCape]:
				"Cinnamoroll Pop-Up Cafe Bowtie and Cloud Cape",
			[CosmeticPackName.MoonlightFrockPack]: "Moonlight Frock and Updo",
			[CosmeticPackName.StyleDapperPack]: "Style Dapper Trio",
			[CosmeticPackName.RovingSnufkinPack]: "Roving Snufkin Robe Set",
			[CosmeticPackName.MoomintrollPack]: "Moomintroll Accessory Set",
			[CosmeticPackName.WonderlandPrimrosePinaforePack]: "Wonderland Primrose Pinafore Set",
			[CosmeticPackName.FortuneSnakePack]: "Fortune Snake Coif and Cloak",
			[CosmeticPackName.TreasureSeekerPack]: "Treasure Seeker's Bounty",
			[CosmeticPackName.TranscendentJourneyPack]: "Transcendent Journey Pack",
			[CosmeticPackName.OceanSeaFoamPack]: "Ocean Sea Foam Set",
			[CosmeticPackName.AnniversaryCinemaPack]: "Anniversary Cinema Set",
			[CosmeticPackName.SpiritedManateePack]: "Spirited Manatee Ensemble",
			[CosmeticPackName.VestigeOfDarkDragonsPack]: "Vestige of Dark Dragons",
			[CosmeticPackName.AnniversaryGownPack]: "Anniversary Gown Ensemble",
			[CosmeticPackName.SunlightBonnetPack]: "Sunlight Bonnet Bundle",
			[CosmeticPackName.MischiefFelinePack]: "Mischief Feline Accessory Duo",
			[CosmeticPackName.FluffyWinterWearPack]: "Fluffy Winter Wear",
			[CosmeticPackName.TournamentSleekSkatingPack]: "Tournament Sleek Skating Set",
		...
		"cosmetic-names": {
			...
			[Cosmetic.DaysOfSummerLightsLantern]: "Moonlight Lantern",
			...
			[Cosmetic.SummerUmbrella]: "Summer Parasol",
			[Cosmetic.SummerShellHairPin]: "Summer Seashell Hairpin",
			...
			[Cosmetic.SummerLightsAccessory]: "Moonlight Bunny Accessory",
			...
			[Cosmetic.JellyShoulderBuddy]: "Sunlight Jelly Shoulder Buddy",
			[Cosmetic.CampfireSnackKit]: "Sunlight Campfire Snack Kit",
			...
			[Cosmetic.StyleBunnySlippers]: "Moonlight Bunny Slippers",
			...
			[Cosmetic.DaysOfLoveAmethystAccessory]: "Days of Love Amethyst Accessory",
			[Cosmetic.DaysOfLoveAmethystTippedTails]: "Days of Love Amethyst-Tipped Tails",
			...
			[Cosmetic.RainbowRibbonShawl]: "Rainbow Shawl",
			[Cosmetic.RainbowFacePaintMask]: "Rainbow Facepaint",
			...
			[Cosmetic.DaysOfColour2026ButterflyKite]: "Butterfly kite",
			[Cosmetic.DaysOfColour2026CrabKite]: "Crab kite",
			[Cosmetic.DaysOfColour2026BirdKite]: "Bird kite",
			[Cosmetic.DaysOfColour2026MantaKite]: "Manta kite",
			[Cosmetic.DaysOfColour2026JellyfishKite]: "Jellyfish kite",
			[Cosmetic.DaysOfColour2026TurtleKite]: "Turtle kite",
			[Cosmetic.DaysOfColour2026ManateeKite]: "Manatee kite",
			[Cosmetic.DaysOfColour2026WhaleKite]: "Whale kite",
			[Cosmetic.DaysOfColour2026LighthornKite]: "Lighthorn kite",
			...
			[Cosmetic.WheatfieldCape]: "Wheatfield Cape",
			[Cosmetic.StarryNightsVisage]: "Starry Night's Visage",
			[Cosmetic.StarryNightsKiss]: "Starry Night's Kiss",
			[Cosmetic.StarryNightsMantleCape]: "Starry Night's Mantle cape",
			[Cosmetic.StarryNightsMantleNeckAccessory]: "Starry Night's Mantle necklace",
			[Cosmetic.EmoteFrustration1]: "Frustration 1",
			[Cosmetic.EmoteFrustration2]: "Frustration 2",
			[Cosmetic.EmoteFrustration3]: "Frustration 3",
			[Cosmetic.EmoteFrustration4]: "Frustration 4",
			[Cosmetic.EmoteBask1]: "Bask 1",
			[Cosmetic.EmoteBask2]: "Bask 2",
			[Cosmetic.EmoteBask3]: "Bask 3",
			[Cosmetic.EmoteBask4]: "Bask 4",
			[Cosmetic.EmoteDraw1]: "Draw 1",
			[Cosmetic.EmoteDraw2]: "Draw 2",
			[Cosmetic.EmoteDraw3]: "Draw 3",
			[Cosmetic.EmoteDraw4]: "Draw 4",
			[Cosmetic.EmoteSlowWalk1]: "Slow walk 1",
		...
		"interaction-response-retired":
			"This response is too old. [Join the support server]({{url}}) for more information!",
		...
		"search-label": "Search",
		share: "Share",
		"share-error": "Unable to share link. Try again.",
		"try-again": "Try again",
		view: "View",
		more: "More",
	...
	features: {
		...
		catalogue: {
			...
			"total-spent-file-title": "Total cost",
			"total-spent-file-description":
				"Your total cost was too big to represent in Discord, so a file had to be made.",
			"total-spent-file-standard-currency": "Standard currency",
			"total-spent-file-seasonal-currency": "Seasonal currency",
		},
		checklist: {
			title: "Checklist",
			...
			"dye-workshop-message-incomplete": "Have you visited the Dye Workshop this week?",
			"dye-workshop-message-complete": "You have visited the Dye Workshop this week!",
		...
		games: {
			guess: {
				...
				"leaderboard-unnamed": "Anonymous",
				"leaderboard-label": "Leaderboard",
				"choose-mode": "Choose a mode",
				"name-required": "To start playing, specify a name.",
				"name-placeholder": "Your name",
				"name-invalid": "That name will not do. Try 1 to {{maximum}} characters.",
				"error-authentication-failed": "Authentication failed.",
				"error-code-required": "A code is required.",
				"error-control-during-game": "Control cannot change during a game.",
				"error-cross-site": "A cross-site request was refused.",
				"error-in-game": "You already have a game in progress.",
				"error-instance-required": "You are in an activity. Play from there instead.",
				"error-name-required": "A name is required to play.",
				"error-no-game-to-answer": "There is no game to answer.",
				"error-no-game-to-end": "There is no game to end.",
				"error-not-authenticated": "You are not signed in.",
				"error-not-connected": "You are not connected to this activity.",
				"error-not-in-control": "Only the player in control can do that.",
				"error-rate-limited": "That was too fast. Try again shortly.",
				"error-someone-else-in-control": "Someone else is in control.",
				"error-target-in-game": "That player already has a game in progress.",
				"error-target-name-required": "That player needs a Sky profile name to play.",
				"error-target-not-connected": "That player is not connected to this activity.",
				"error-unknown-answer": "An unknown answer was given.",
				"error-unknown-instance": "An unknown instance was given.",
				"error-unknown-mode": "An unknown mode was given.",
				streak: "Streak",
				highest: "Highest",
				spectating: "{{name}} is playing.",
				"spectating-waiting": "Waiting for {{name}} to start.",
				"spectating-no-host": "Waiting for someone to take control.",
				"connection-elsewhere": "You are no longer in this activity.",
				"connection-expired": "Your session expired. Sign in again to keep playing.",
				"connection-limit": "You have this activity open too many times.",
				"connection-lost": "Lost connection to the activity.",
				"connection-rejected": "The activity refused this connection.",
				"connection-timed-out": "Connecting to the activity took too long.",
				retry: "Try again",
				"give-control": "Give control",
				"take-control": "Take control",
				host: "Host",
				"presence-selecting": "Selecting a game…",
				share: "Share",
				"share-message_one": "I got {{count}} in a row in {{mode}}! Can you beat that?",
				"share-message_other": "I got {{count}} in a row in {{mode}}! Can you beat that?",
				"sky-profile-website": "Customise your full Sky profile",
				website: "Website",
			},
		},
		heart: {
		...
		"sky-profile": {
			...
			"explore-all": "Explore all Sky profiles",
